  ...
  <section class="signup">
    ...
    <div class="signup_content">
      ...
      <div class="signup_wrapper">
        <h5>First register an account to access the courses</h5>
        <form>
          ...
          <button type="submit"><RouterLink to="/login">Sign Up</RouterLink></button>
        </form>
      </div>
    </div>
  </section>
...
.signup_wrapper {
  ...
  z-index: 10001;
  margin-top: 10rem; 
  margin-bottom: 15rem; /* Space between the button and footer */
}
